# Angular 12 Tour of Heroes

This is a reproduction / copy of the [Angular Tour of Heroes tutorial](https://v12.angular.io/tutorial) that includes the New Relic Browser Agent. The original tutorial code is included [here](./toh-pt6.zip) for reference.
